...
public class Receiver extends Panel implements Runnable
{
	...
	public Receiver( SerialPortDisplay owner, int rows, int cols )
	{
		super();
	...
	public Receiver( SerialPortDisplay owner, int rows, int cols, int delay )
	{
	...
	public Receiver( SerialPortDisplay owner, int rows, int cols, int delay, boolean silentReceive )
	{
		this(owner, rows, cols);
