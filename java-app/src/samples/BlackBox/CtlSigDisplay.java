...
public class CtlSigDisplay extends Panel
{
	...
	ToggleLabel RTSLabel, DTRLabel, OELabel, FELabel, PELabel, BILabel;
	Label CTSLabel, DSRLabel, RILabel, CDLabel, DALabel, BELabel;
	boolean DA, BE;
	...
	public void showValues()
	{
		if (this.port != null)
		{
			...
			CTSLabel.setForeground(port.isCTS() ? onColor : offColor);

			DTRLabel.setState(port.isDTR());
			DSRLabel.setForeground(port.isDSR() ? onColor : offColor);
	...
	public void showErrorValues()
	{
		if (this.port != null)
		{
			...
			OELabel.setForeground(OELabel.getState() ? onColor : offColor);

			FELabel.setForeground(FELabel.getState() ? onColor : offColor);

			PELabel.setForeground(PELabel.getState() ? onColor : offColor);

			BILabel.setForeground(BILabel.getState() ? onColor : offColor);
