...
/*
 * @(#)AlertDialog.java	1.7 00/05/04 SMI
 * 
...
public class AlertDialog extends Dialog implements ActionListener
{
	 ...
	 *            Any Frame.
	 * @param title
	 *            The title to appear in the border of the dialog.
	 * @param lineOne
	 *            The first line of the message in the dialog.
	 * @param lineTwo
	 *            The second line of the message in the dialog.
	 * @param lineThree
	 *            The third line of the message in the dialog.
	 */
	public AlertDialog( Frame parent, String title, String lineOne, String lineTwo, String lineThree )
	{
		...
		int width = Math.max(fm.stringWidth(lineOne), Math.max(fm.stringWidth(lineTwo), fm.stringWidth(lineThree)));
