...
/*
 * @(#)PortRequestedDialog.java	1.7 00/05/04 SMI
 * 
...
/**
 * Informs the user that an other application has requested the port they are
 * using, and then asks if they are willing to give it up. If the user answers
 * "Yes" the port is closed and the dialog is closed, if the user answers "No"
 * the dialog closes and no other action is taken.
 */
